...
export function ModalWin({
  ...
  const puntosGuardados = JSON.parse(
    localStorage.getItem(`${data.gameTitle}-${preguntasCant}`)
  );
    ...
    return (
      <section className='winner'>
        <div className='text'>
          ...
          <Link to='/'>
            <div className='btnWinner' onClick={() => saveLocal()}>
              Guardar puntaje
            </div>
          </Link>
        </div>
