...
export const Image = ({consignasData, index, preguntasCant, isCorrect, siguiente}) => {
  return (
    <div className='image'>
      ...
      {isCorrect === undefined? <h1 className='imageCorrect'style={{display:"none"}}></h1>: isCorrect?<h1 className='imageCorrect' style={{color:"#4cb84c", display:"inline"}}>Correcto</h1>:<h1 className='imageCorrect' style={{color:"#d64040"}}>Incorrecto</h1>}
